...
const string_minutes_ago = "minutes (y) ago";
const string_hours_ago = "hours (s) ago";
...
const string_user_online = "<span class = 'green-text'> Active now </ span>";
const string_user_offline = "Last was active:";
...
const string_no_voting_for_self = "You can not respond to your own messages.";
const string_reaction_positive = "You have responded positively.";
...
const string_group_joinChannel = "Attach to conversation";
const string_joinChannel_success = "Attached to conversation #";
...
const string_first_login = "This is the first login.";
const string_second_login = "This is not the first login.";
